...
$query_categoria = "SELECT id, nombre, icono FROM categorias WHERE nombre = 'Ciencia Ficción'";
...
<head>
    <meta charset="UTF-8">
    <title>PELIX | Ciencia Ficción</title>
...
<div class="contenido">
    <div class="seccion-proximamente-header" style="margin-top: 20px;">
        <h2>
            <img src="<?= htmlspecialchars($cat_icono) ?>" alt="Próximamente">
