...
$query_categoria = "SELECT id, nombre, icono FROM categorias WHERE nombre = 'Comedia'";
...
$query_pelis = "SELECT titulo, imagen FROM peliculas WHERE categoria_id = $cat_id ORDER BY id DESC";
...
<div class="contenido">
    <div class="seccion-proximamente-header" style="margin-top: 20px;">
        <h2>
            <img src="<?= htmlspecialchars($cat_icono) ?>" alt="Comedia">
